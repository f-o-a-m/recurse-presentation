...
```haskell
eth_sendTransaction :: forall p e
                     . IsAsyncProvider p
                    => TransactionOptions
                    -> Web3 p e HexString
eth_sendTransaction opts =
  unsafeCoerceWeb3 $ remote "eth_sendTransaction" opts :: Web3 p () HexString
```
- Pretty easy!
...
class TxMethod (selector :: Symbol) a where
    sendTx :: forall p e u.
      ...
      -> u             -- paymentValue in some denomination
